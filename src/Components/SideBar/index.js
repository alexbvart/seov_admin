...
const SideBar = () => {
    return (
        <>
                <div className="min-h-screen flex flex-col top-0 left-0 w-64 max-w-xs p-4 bg-white py-6">
                    <ul className="flex flex-col w-full ">
                        ...
                        <li className="my-px">
                            <span className="flex font-medium text-sm text-gray-400 px-4 my-4 uppercase">OPERACIONES</span>
                        </li>
                        <li className="my-px">
                        <Link href="/carreras">
                            <a 
                        ...
                        <Link href="/alumnos">
                            <a 
                                ...
                                <span className="ml-3">Alumnos</span>
                        ...
                        <Link href="/tutores">
                            <a 
                                ...
                                <span className="ml-3">Tutores</span>
                                {/* <span className="flex items-center justify-center text-sm text-gray-500 font-semibold bg-gray-200 h-6 px-2 rounded-full ml-auto">1k</span> */}
                            </a>
                        </Link>
                        </li>
